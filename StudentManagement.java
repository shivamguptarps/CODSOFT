...
class Student {
    ...
    Student(String name, int roll, int[] subjectMarks, int totalMarks, int numberOfSubjects, String grade,
        ...
        this.roll = roll; // student's roll number
        this.subjectMarks = subjectMarks; // array of subject marks
        this.totalMarks = totalMarks; // total marks obtained
        this.numberOfSubjects = numberOfSubjects; // number of subjects
        this.grade = grade; // student's grade
        this.averagePercentage = averagePercentage; // average percentage
    }
